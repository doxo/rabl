  ...
  class Engine
    ...
    def to_hash(options={})
      ...
      if is_record?(data) || !data # object @user
        ...
        data.map do |object|
          Rabl::Builder.new(@_collection_name ? {object => @_collection_name.to_s.singularize} : object,
    ...
    def format_json(json_output)
      if Rabl.configuration.json_engine == :default
        ...
        json_method = json_engine.respond_to?(:dump) ? 'dump' : 'encode' # multi_json compatibility
